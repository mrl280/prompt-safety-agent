...
class QwenAnalyzer(Analyzer):
    ...
    def analyze(self, prompt: str) -> Optional[SafetyReport]:
        """
        Analyze a prompt using the local LLM, returning a SafetyReport if possible.
        ...
        return self.parse_safety_report(response_text)

    def parse_safety_report(self, response_text: str) -> Optional[SafetyReport]:
        """
